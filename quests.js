const quests = [
    ...
    { quest: "send 10 messages in #general in the span of 1 hour, no spam allowed", difficulty: "Medium", reward: 30 },
...
const complimentKeywords = [
    ...
    "well crafted", "deep", "thoughtful", "emotional", "gripping", "fascinating", "scrumptious", "ate my phone","yummy",
